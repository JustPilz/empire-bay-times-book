...
```md
![alt-текст, который появится, если картинка недоступна](http://placehold.it/150x100)
```
##### Изображение с `alt`-текстом и `title`-текстом (наведи мышкой на изображение):
![alt-текст](http://placehold.it/150x100 "Можно задать title-текст")
```md
![alt-текст](http://placehold.it/150x100 "Можно задать title-текст")
```
...
[![alt-текст](http://placehold.it/150x100)](http://example.com/)
```md
