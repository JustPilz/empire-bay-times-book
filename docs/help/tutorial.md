# Руководство по серверу Night City RolePlay
...
1. Прибыть к серому ключу на карте либо найти в городе автомобили ярко-жёлтого цвета.
...
2. Договориться о сумме.

3. Получить от владельца ключи как предмет инвентаря.

4. Передать деньги владельцу: `/send id сумма`, например `/send 7 800`


## Налог на автомобиль {#tax}

Сумма начисляемого налога зависит от текущей стоимости авто.

> [info]
> Если не оплачивать своевременно налог, то сотрудник полиции EBPD имеет право отправить ваш автомобиль на штрафстоянку.
...
2. Войти в здание мэрии

3. Написать команду `/tax`, чтобы увидеть список всех ваших автомобилей и сумму начисленного налога по каждому

4. Оплатить налог по конкретному автомобилю: например: `/tax AB-123`
...
1. Иметь в наличных средствах нужную сумму для оплаты штрафа.
...
## Одежда {#clothes}
Вам надоела одежда вашего персонажа? И вы хотите сменить ему прикид? Тогда вам нужно посетить сеть магазинов одежды Dipton Apparel и ателье Vangel's (Вэнджелла). На карте этим места обозначены серым кружком с белой шляпой внутри.

Чтобы купить одежду, вам следует:

1. Приехать в магазин одежды или в ателье Вэнджелла (отмечены на карте серым кружком с белой шляпой внутри)
...
5. Ознакомиться с ассортиментом, обращая внимания на цифры, указанные в квадратных скобках

6. Купить нужную одежду или отправиться в другой магазин

Каждый магазин имеет свой ассортимент. Поэтому наличие нужной одежды смотрите в магазинах одежды в самой игре.  
Не все модели, изображённые ниже, доступны для покупки.

![Скины - Лист 1](https://i0.wampi.ru/2020/01/26/skins1.jpg)
![Скины - Лист 2](https://i8.wampi.ru/2020/01/26/skins2.jpg)
![Скины - Лист 3](https://i9.wampi.ru/2020/01/26/skins3.jpg)
![Скины - Лист 4](https://i0.wampi.ru/2020/01/26/skins4.jpg)
